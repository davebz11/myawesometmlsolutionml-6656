[myawesometmlsolutionml-6656] Operating Details
====================================
...
.. important::
   ...
   **not be valid if your [myawesometmlsolutionml-6656] container is NOT running**.

.. tip::
   You must have your [myawesometmlsolutionml-6656] container running before connecting to the Visualization and Airflow URLs.
...
.. important::
   https://github.com/davebz11/raspberrypi/blob/main/tml-airflow/logs/logs.txt
...
.. important::
   docker run -d \-\-net=host \-\-env AIRFLOWPORT=9000  -v <change to your local folder>:/dagslocalbackup:z  -v /var/run/docker.sock:/var/run/docker.sock:z  \-\-env GITREPOURL=https://github.com/davebz11/raspberrypi  \-\-env CHIP=amd64 \-\-env TSS=1 \-\-env SOLUTIONNAME=TSS  \-\-env EXTERNALPORT=40179  \-\-env VIPERVIZPORT=9005  \-\-env GITUSERNAME='davebz11'  \-\-env DOCKERUSERNAME='marley88'  \-\-env MQTTUSERNAME='davebz'  \-\-env KAFKACLOUDUSERNAME=''  \-\-env KAFKACLOUDPASSWORD='<Enter your API secret>'  \-\-env READTHEDOCS='<Enter your readthedocs token>'  \-\-env GITPASSWORD='<Enter personal access token>'  \-\-env DOCKERPASSWORD='<Enter your docker hub password>'  \-\-env MQTTPASSWORD='<Enter your mqtt password>'  maadsdocker/tml-solution-studio-with-airflow-amd64
...
.. important::
   marley88/myawesometmlsolutionml-6656-amd64 (https://hub.docker.com/r/marley88/myawesometmlsolutionml-6656-amd64)
...
.. important::
   docker run -d -p 42063:42063 -p 56941:56941 -p 50171:50171 \-\-env TSS=0 \-\-env SOLUTIONNAME=myawesometmlsolutionml-6656 \-\-env SOLUTIONDAG=solution_preprocessing_dag_mqtt-myawesometmlsolutionml-6656 \-\-env GITUSERNAME=davebz11  \-\-env GITREPOURL=https://github.com/davebz11/raspberrypi \-\-env SOLUTIONEXTERNALPORT=42063  \-\-env CHIP=amd64 \-\-env SOLUTIONAIRFLOWPORT=56941  \-\-env SOLUTIONVIPERVIZPORT=50171 \-\-env DOCKERUSERNAME='marley88'  \-\-env EXTERNALPORT=40179 \-\-env KAFKACLOUDUSERNAME=''  \-\-env VIPERVIZPORT=9005 \-\-env MQTTUSERNAME='davebz' \-\-env AIRFLOWPORT=9000  \-\-env MQTTPASSWORD='<Enter mqtt password>'  \-\-env KAFKACLOUDPASSWORD='<Enter API secret>'  \-\-env GITPASSWORD='<Enter Github Password>'  \-\-env READTHEDOCS='<Enter Readthedocs token>'  marley88/myawesometmlsolutionml-6656-amd64
...
.. list-table::
   ...
   * - \-\-env KAFKACLOUDPASSWORD
     - This is your API Secret from Confluent Cloud.
   * - marley88/myawesometmlsolutionml-6656-amd64
...
[myawesometmlsolutionml-6656] Github Repo
---------------
This is the Github repo for all your solution code

.. important::
   https://github.com/davebz11/raspberrypi/tree/main/tml-airflow/dags/tml-solutions/myawesometmlsolutionml-6656
...
.. important::
   https://myawesometmlsolutionml-6656.readthedocs.io
...
.. important::
   solution_preprocessing_dag_mqtt-myawesometmlsolutionml-6656
...
.. important::
   VIPERHOST_PRODUCE=127.0.1.1, VIPERPORT_PRODUCE=42063, VIPERHOST_PREPOCESS=127.0.1.1, VIPERPORT_PREPROCESS=33551, VIPERHOST_PREPOCESS2=127.0.1.1, VIPERPORT_PREPROCESS2=45275, VIPERHOST_PREPOCESS_PGPT=127.0.1.1, VIPERPORT_PREPROCESS_PGPT=39235, VIPERHOST_ML=127.0.1.1, VIPERPORT_ML=42635, VIPERHOST_PREDCT=127.0.1.1, VIPERPORT_PREDICT=41567, HPDEHOST=127.0.1.1, HPDEPORT=33529, HPDEHOST_PREDICT=127.0.1.1, HPDEPORT_PREDICT=41019

Your Solution TMUX Windows 
-----------------------

.. important::
   python-produce-2937-myawesometmlsolutionml-6656,solution_preprocessing_dag_mqtt-myawesometmlsolutionml-6656, python-preprocess-773-myawesometmlsolutionml-6656,solution_preprocessing_dag_mqtt-myawesometmlsolutionml-6656, viper-produce, viper-preprocess, viper-preprocess-pgpt, viper-ml, viper-predict
